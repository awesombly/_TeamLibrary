...
public:
	...
	virtual bool Frame(const float& spf, const float& accTime) noexcept { return true; spf; accTime; }
	virtual bool Render(ID3D11DeviceContext* pContext) noexcept { return true; pContext;}
